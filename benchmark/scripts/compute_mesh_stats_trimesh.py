...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--json-path", type=Path, default=None, help="Output JSON path (default: mesh_stats_trimesh.json).")
    parser.add_argument("--csv-path", type=Path, default=None, help="Output CSV path (default: mesh_stats_trimesh.csv).")
...
def main() -> int:
    ...
    json_path, csv_path = default_output_paths(dataset_dir, "trimesh", args.json_path, args.csv_path)
